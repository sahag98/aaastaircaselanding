...
const Navbar = () => {
  ...
  return (
    <nav className="py-4 flex  items-center justify-between">
      ...
      <button className="hidden md:flex lg:flex items-center gap-2 bg-accent px-4 py-2 rounded-md text-primary hover:bg-accent/80 transition">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
      ...
      {open && (
        <div className="absolute bg-primary border flex justify-end shadow top-0 right-0 h-full w-3/4">
          <div className="relative items-center gap-8 flex flex-col justify-center w-full">
            ...
            <button className="items-center flex gap-2 bg-accent px-4 py-2 rounded-md text-primary hover:bg-accent/80 transition">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
